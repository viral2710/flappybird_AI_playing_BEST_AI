...
def draw_windows(win, birds, pipes,gen, base, score):
	...
	pygame.display.update()
def draw_windowb(win, birds, pipes,s, base, score):
	win.blit(BG_IMG, (0,0))
	for pipe in pipes:
		pipe.draw(win)
	base.draw(win)
	...
	text = STAT_FONT.render("Score: "+str(score),1,(255,255,255))
	win.blit(text,(WIN_WIDTH-10-text.get_width(),10))
	score_label = STAT_FONT.render( s,1,(255,255,255))
	win.blit(score_label, (10, 10))
...
def eval_genomes(genomes, config):
	...
	while run:
		...
		if score>50:
			break
		base.move()
		draw_windows(win,birds,pipes,gen,base,score)
...
def eval_genome(genomes, config):
	...
	while run:
		...
		base.move()
		s ="Best"
		draw_windowb(win,birds,pipes,s,base,score)
